  ...
  return (
    <section className="border-ink grid border-t-[3px] md:grid-cols-3">
      <div className="border-ink border-r-0 border-b-[3px] p-8 md:border-r-[3px] md:border-b-0">
        <div className="border-ink bg-ink mb-4 h-10 w-10 rounded-full border-2" />
      ...
      <div className="border-ink border-r-0 border-b-[3px] p-8 md:border-r-[3px] md:border-b-0">
        <div className="border-ink mb-4 h-10 w-10 rounded-full border-2" />
      ...
      <div className="border-ink border-b-[3px] p-8 md:border-b-0">
        ...
        <p className="mt-2 text-sm leading-relaxed">
          Download .xlsx or .csv. Your documents are never stored—encrypted and compliant.
        </p>
      </div>
    </section>
  );
